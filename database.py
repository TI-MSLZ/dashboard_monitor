...
def garantir_tabela_configuracoes_agentes(conn):
    cur = conn.cursor()
    if DB_BACKEND == "sqlite":
        cur.execute("""
            CREATE TABLE IF NOT EXISTS configuracoes_agentes (
                loja_id INTEGER PRIMARY KEY,
                configuracao_cifrada BLOB NOT NULL,
        ...
        cur.execute("""
            CREATE TABLE IF NOT EXISTS configuracoes_agentes (
                ...
                configuracao_cifrada LONGBLOB NOT NULL,
                versao INT UNSIGNED NOT NULL DEFAULT 1,
                alterado_por VARCHAR(80) NOT NULL,
                alterado_em VARCHAR(19) NOT NULL,
                sincronizado_em VARCHAR(19) NULL,
                ultimo_erro VARCHAR(500) NULL,
                PRIMARY KEY (loja_id),
                CONSTRAINT fk_configuracoes_agentes_lojas FOREIGN KEY (loja_id)
